...
import lsb_steganography as stego  # алгоритм

class Ui_MainWindow(object):

    #Функция отображения сообщения/ошибки/информации
    ...
    #Функция выбора входного файла пикселей
    ...
    #Функция отображения диалога сохранения файла
    def saveFile(self):
        output_path = QtWidgets.QFileDialog.getSaveFileName(None, 'Save encoded file','',"PNG File(*.png)")[0]
        return output_path


    #Функция кодирования данных и сохранения файла
    def encode(self):
